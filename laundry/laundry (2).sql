...
--
-- Host: localhost:3307
-- Waktu pembuatan: 19 Nov 2023 pada 13.34
...
(10, 4, 'cd', 8),
(11, 4, 'kaos kaki', 4),
(12, 4, 'baju dinas uinsu biru stambuk 2022', 2),
(13, 4, 'sepatu', 1),
(14, 4, 'celana pendek', 1),
(15, 4, 'celana setengah', 1),
(16, 4, 'kemeja', 1);
...
(1, 'ilham hasby', '0851777777', 'klt'),
(2, 'wayhu', '0822898898', 'papua'),
(3, 'farid', '0866667677', 'Nibung raya'),
(4, 'farhan', '0888989988', 'jl.stm'),
(6, 'jamal', '08911', 'jermal ujung ');
...
(1, '2023-11-13', 1, 25000, 5, '2023-11-05', 1),
(2, '2023-11-13', 2, 20000, 4, '2023-11-13', 0),
(3, '2023-11-13', 3, 10000, 2, '2023-11-12', 0),
(4, '2023-11-15', 6, 5000, 1, '2023-11-15', 0);
...
--
ALTER TABLE `pakaian`
  MODIFY `pakaian_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
